...
@section('content')
    ...
    <section style="height: 100vh_; min-height: 630px; object-fit: cover;"
        ...
        <div class="html5vid video-loaded" id="video-rpptn"><video playsinline="" style="object-fit: cover;"
                                                                   autoplay loop muted="true" poster="{{asset('home/templates/bit_gold/invetoro/assets/images/shapes/main-slider-three-shape-1.png')}}" preload="auto">
                ...
                <div class="col-xl-6">
                    <div class="trusted-company__left">
                        <div class="trusted-company__img wow slideInLeft" data-wow-delay="100ms"
                            ...
                            <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/invetoro_office.jpg')}}" alt="">
                    ...
                    <div class="trusted-company__right">
                        <div class="section-title text-left" style="margin-bottom:0">
                            <div class="section-title__tagline-box">
                                ...
                                <div class="section-title-shape">
                                    <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/shapes/section-title-shape.png')}}" alt="">
                                </div>
                            </div>
                            <h2 class="section-title__title">About Us</h2>
                        </div>
                        <p class="trusted-company__text-2">We are an international financial company engaged in investment activities, which are related to trading on financial markets and cryptocurrency exchanges performed by qualified professional traders.<br />
                            <br />
                            Our goal is to provide our investors with a reliable source of high income, while minimizing any possible risks and offering a high-quality service, allowing us to automate and simplify the relations between the investors and the trustees. We work towards increasing your profit margin by profitable investment. We look forward to you being part of our community. <a href="about" class="text-primary">...more</a></p>
                        ...
                        <div class="trusted-company__person">
                            <div class="trusted-company__person-img">
                                <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/resources/trusted-company-person-img.jpg')}}" alt="">
                            </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <div class="main-slider-three__shape-1">
                        <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/shapes/main-slider-three-shape-1.png')}}" alt="">
                    </div>
                    <div class="main-slider-three__shadow zoominout-2">
                        <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/shapes/main-slider-three-shadow.png')}}" alt="">
                    </div>
                    <div class="main-slider-three__img">
                        <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/resources/main-slider-three-img-3.jpg')}}" alt="">
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-9">
                                <div class="main-slider__content">
                                    ...
                                    <p class="text-white">We help investors scale their dividends through our innovative and lucrative strategies.</p>
    ...
    <section data-animate="fadeIn" style="padding-top: 45px; padding-bottom: 30px !important;background-image: url('{{asset('home/img/feature-bg')}});background-size: all;">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="services-three__top-right">
                            <p class="services-three__top-text">We are dedicated to helping investors around the world reach their desired investment goals and broaden their financial horizons.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="services-three__single">
                            <div class="services-three__img">
                                <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/services/services-3-1.jpg')}}" alt="">
                            ...
                            <div class="services-three__content">
                                ...
                                <p class="services-three__text">Our company conducts absolutely legal activities in the legal field. We are certified to operate investment business, we are legal and safe..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="services-three__single">
                            <div class="services-three__img">
                                <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/services/services-3-2.jpg')}}" alt="">
                            ...
                            <div class="services-three__content">
                                ...
                                <p class="services-three__text">We are trusted by a huge number of people. We are working hard constantly to improve the level of our security system and minimize possible risks..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="services-three__single">
                            <div class="services-three__img">
                                <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/services/services-3-3.jpg')}}" alt="">
                            ...
                            <div class="services-three__content">
                                ...
                                <p class="services-three__text">Anonymity and using cryptocurrency as a payment instrument. In the era of electronic money – this is one of the most convenient ways of cooperation..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="services-three__single">
                            <div class="services-three__img">
                                <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/services/services-3-4.jpg')}}" alt="">

                            </div>
                            <div class="services-three__content">
                                <div class="services-three__icon">
                                    <i class="fa fa-shipping-fast"></i>                                    </div>
                                <h3 class="services-three__title"><a href="#">Quick Withdrawal</a></h3>
                                <p class="services-three__text">Our all retreats are treated spontaneously once requested. There are high maximum limits. The minimum withdrawal amount is only $10 ..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="services-three__single">
                            <div class="services-three__img">
                                <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/services/services-3-5.jpg')}}" alt="">
                            ...
                            <div class="services-three__content">
                                ...
                                <p class="services-three__text">We are offering a certain level of referral income through our referral program. you can increase your income by simply refer a few people..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="services-three__single">
                            <div class="services-three__img">
                                <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/services/services-3-6.jpg')}}" alt="">

                            </div>
                            <div class="services-three__content">
                                <div class="services-three__icon">
                                    <i class="fa fa-headset"></i>                                    </div>
                                <h3 class="services-three__title"><a href="#">24/7 Support</a></h3>
                                <p class="services-three__text">We provide 24/7 customer support through e-mail and telegram. Our support representatives are periodically available to elucidate any difficulty..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="services-three__single">
                            <div class="services-three__img">
                                <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/services/services-3-7.jpg')}}" alt="">
                            ...
                            <div class="services-three__content">
                                ...
                                <p class="services-three__text">We are using a dedicated server for the website which allows us exclusive use of the resources of the entire server..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="services-three__single">
                            <div class="services-three__img">
                                <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/services/services-3-8.jpg')}}" alt="">
                            ...
                            <div class="services-three__content">
                                ...
                                <p class="services-three__text">Comodo Essential-SSL Security encryption confirms that the presented content is genuine and legitimate..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="services-three__single">
                            <div class="services-three__img">
                                <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/services/services-3-9.jpg')}}" alt="">

                            </div>
                            <div class="services-three__content">
                                <div class="services-three__icon">
                                    <i class="fa fa-shield-alt"></i>                                    </div>
                                <h3 class="services-three__title"><a href="#">DDOS Protection</a></h3>
                                <p class="services-three__text">We are using one of the most experienced, professional, and trusted DDoS Protection and mitigation provider..</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xl-7">
                    <div class="notech-more__left">
                        ...
                        <p class="notech-more__text">{{$siteName}} is duely registered with the UK authority and licensed to conduct businesses in the US and almost all parts of Europe, Asia and Africa.</p>
    ...
    <section class="business-from-two">
        <div class="business-from-two-img">
            <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/resources/business-from-two-img.jpg')}}" alt="">
        </div>
        ...
        <div class="container">
            <div class="section-title text-left">
                ...
                <h4 class="business-from-two__title">{{$siteName}} is behind a family of products that provides investors with access<br> to the digital currency asset class. </h4>
            </div>
                ...
                <div class="testimonial-two__single">
                    <div class="testimonial-two__single-inner">
                        <div class="testimonial-two__icon">
                            <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/icon/testimonial-two-icon.png')}}" alt="">
                        </div>
                        <p class="testimonial-two__text">
                            I have invested with this platform and gotten my money in my account. This is legit and safe. Great doing business with them.</p>
                        ...
                        <div class="testimonial-two-shape">
                            <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/shapes/testimonial-two-shape.png')}}" alt="">
                        </div>
                    </div>
                </div>
                <div class="testimonial-two__single">
                    <div class="testimonial-two__single-inner">
                        ...
                        <p class="testimonial-two__text">
                            Legit....and legit. Although the payment was processed manually, I have received my first payment within a very short time., I think nice for invest at this site.</p>
                        <div class="testimonial-two__client-info">
                            <div class="testimonial-two__client-img">
