            ...
            <div class="delivering-it__bottom">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="delivering-it__single">
                            <div class="delivering-it__img">
                                <img src="assets/images/resources/delivering-it-img-1" alt="">
                            </div>
                            <div class="delivering-it__content">
                                <h5 class="delivering-it__content-title">Digital Currencies
                                </h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div class="delivering-it__single">
                            <div class="delivering-it__img">
                                <img src="assets/images/resources/delivering-it-img-2" alt="">
                            </div>
                            <div class="delivering-it__content">
                                <h5 class="delivering-it__content-title">Oil and Gas</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="delivering-it__single">
                            <div class="delivering-it__img">
                                <img src="assets/images/resources/delivering-it-img-3" alt="">
                            </div>
                            <div class="delivering-it__content">
                                <h5 class="delivering-it__content-title">Agriculture</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6">
                    <div class="trusted-company__left">
                        <div class="trusted-company__img wow slideInLeft" data-wow-delay="100ms"
                            ...
                            <img src="{{asset('home/templates/bit_gold/invetoro/assets/images/resources/trusted-company-img-1.jpg')}}" alt="">
                    ...
                    <div class="team-one__single">
                        ...
                        <div class="team-one__content-box">
                            <div class="team-one__content">
                                ...
                                <p class="team-one__title">Chief Information Officer &amp;amp; Internal Business Relation Officer</p>
                            </div>
                        </div>
                    </div>
                </div>
