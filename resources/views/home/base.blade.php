...
<head>
    ...
    <meta name="keywords"
        content="bitcoin,investment,ethereum,mining,trading,send bitcoin,sell,buy,crypto,cryptocurrency,online platform for cryptocurrency trading,metavat,metavat.ltd">
    ...
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/bootstrap/css/bootstrap.min.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/animate/animate.min.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/animate/custom-animate.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/fontawesome/css/all.min.css')}}" />
    <link rel="stylesheet" href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/jarallax/jarallax.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/nouislider/nouislider.min.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/nouislider/nouislider.pips.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/odometer/odometer.min.css')}}" />
    ...
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/notech-two-icons/style.css')}}">
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/tiny-slider/tiny-slider.min.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/reey-font/stylesheet.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/owl-carousel/owl.carousel.min.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/owl-carousel/owl.theme.default.min.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/bxslider/jquery.bxslider.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/bootstrap-select/css/bootstrap-select.min.css')}}" />
    <link rel="stylesheet" href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/vegas/vegas.min.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/jquery-ui/jquery-ui.css')}}" />
    <link rel="stylesheet"
        href="{{asset('home/templates/bit_gold/invetoro/assets/vendors/timepicker/timePicker.css')}}" />
    <!-- template styles -->
    ...
    <!-- modes css -->
    <link rel="stylesheet" id="jssMode"
        href="{{asset('home/templates/bit_gold/invetoro/assets/css/notech-light.css')}}">
...
<body>
                ...
                <div class="main-menu__wrapper clearfix">
                    <div class="main-menu__left main-menu__left--two">
                        <div class="main-menu__logo">
                            <a href="{{url('/')}}">
                                <img class="logo-dark" src="{{asset('home/images/'.$web->logo)}}" width="143"
                                    alt="{{ $siteName }}">
                                <img class="logo-light" src="{{asset('home/images/'.$web->logo)}}" width="143"
                                    alt="{{ $siteName }}">
                            </a>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget__column footer-widget__about">
                                <div class="footer-widget__logo">
                                    <a href="{{url('/')}}"><img src="{{asset('home/images/'.$web->logo)}}" width="143"
                                            height="39" alt=""></a>
                                </div>
                                ...
                                <form class="footer-widget__newsletter-form subscribe-form" method="post">
                                    <input type="hidden" name="_token" value="kocVwb7AGyTQ4D7IyYs8Qvku8MVuovNSFrDyEScG">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="site-footer__bottom-inner">
                                <p class="site-footer__bottom-text">Copyright © 2017 - {{date('Y')}} <a
                                        href="{{url('/')}}"><strong>{{$siteName}}</strong></a>. All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{asset('home/templates/bit_gold/invetoro/assets/vendors/jquery-ajaxchimp/jquery.ajaxchimp.min.js')}}">
    </script>
    <script src="{{asset('home/templates/bit_gold/invetoro/assets/vendors/jquery-appear/jquery.appear.min.js')}}">
    </script>
    <script
        src="{{asset('home/templates/bit_gold/invetoro/assets/vendors/jquery-circle-progress/jquery.circle-progress.min.js')}}">
    </script>
    <script
        src="{{asset('home/templates/bit_gold/invetoro/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.min.js')}}">
    </script>
    <script src="{{asset('home/templates/bit_gold/invetoro/assets/vendors/jquery-validate/jquery.validate.min.js')}}">
    </script>
    ...
    <script src="{{asset('home/templates/bit_gold/invetoro/assets/vendors/owl-carousel/owl.carousel.min.js')}}">
    </script>
    <script src="{{asset('home/templates/bit_gold/invetoro/assets/vendors/bxslider/jquery.bxslider.min.js')}}"></script>
    <script
        src="{{asset('home/templates/bit_gold/invetoro/assets/vendors/bootstrap-select/js/bootstrap-select.min.js')}}">
    </script>
    ...
    <script src="{{asset('home/templates/bit_gold/invetoro/assets/vendors/toolbar/js/jQuery.style.switcher.min.js')}}">
    </script>
    ...
    _smartsupp.key = 'a0aa79a7939313bb3271a7e2c2d94075deb8e94c';
